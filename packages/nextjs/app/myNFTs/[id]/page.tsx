...
const MyNFTs: NextPage = () => {
  ...
  const [uri, setUri] = useState(`https://ipfs.io/ipfs/${ipfsHash}`);

  useEffect(() => {
    if (ipfsHash) {
      setUri(`https://ipfs.io/ipfs/${ipfsHash}`); // Construct the token URI from IPFS hash
    }
  }, [ipfsHash]);
